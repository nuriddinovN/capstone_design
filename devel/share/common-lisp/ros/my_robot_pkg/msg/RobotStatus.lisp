...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_pkg-msg:<RobotStatus> is deprecated: use my_robot_pkg-msg:RobotStatus instead.")))

(cl:ensure-generic-function 'robot_name-val :lambda-list '(m))
(cl:defmethod robot_name-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:robot_name-val is deprecated.  Use my_robot_pkg-msg:robot_name instead.")
  (robot_name m))

(cl:ensure-generic-function 'battery_level-val :lambda-list '(m))
(cl:defmethod battery_level-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:battery_level-val is deprecated.  Use my_robot_pkg-msg:battery_level instead.")
  (battery_level m))

(cl:ensure-generic-function 'is_moving-val :lambda-list '(m))
(cl:defmethod is_moving-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:is_moving-val is deprecated.  Use my_robot_pkg-msg:is_moving instead.")
  (is_moving m))

(cl:ensure-generic-function 'error_code-val :lambda-list '(m))
(cl:defmethod error_code-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:error_code-val is deprecated.  Use my_robot_pkg-msg:error_code instead.")
  (error_code m))
