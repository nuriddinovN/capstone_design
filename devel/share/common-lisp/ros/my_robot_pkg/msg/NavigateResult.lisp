...
(cl:defmethod cl:initialize-instance :after ((m <NavigateResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_pkg-msg:<NavigateResult> is deprecated: use my_robot_pkg-msg:NavigateResult instead.")))

(cl:ensure-generic-function 'success-val :lambda-list '(m))
(cl:defmethod success-val ((m <NavigateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:success-val is deprecated.  Use my_robot_pkg-msg:success instead.")
  (success m))

(cl:ensure-generic-function 'status_message-val :lambda-list '(m))
(cl:defmethod status_message-val ((m <NavigateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:status_message-val is deprecated.  Use my_robot_pkg-msg:status_message instead.")
  (status_message m))

(cl:ensure-generic-function 'total_distance-val :lambda-list '(m))
(cl:defmethod total_distance-val ((m <NavigateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:total_distance-val is deprecated.  Use my_robot_pkg-msg:total_distance instead.")
  (total_distance m))

(cl:ensure-generic-function 'time_elapsed-val :lambda-list '(m))
(cl:defmethod time_elapsed-val ((m <NavigateResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pkg-msg:time_elapsed-val is deprecated.  Use my_robot_pkg-msg:time_elapsed instead.")
  (time_elapsed m))
