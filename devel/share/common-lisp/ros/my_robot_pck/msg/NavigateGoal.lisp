...
(cl:defmethod cl:initialize-instance :after ((m <NavigateGoal>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateGoal)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_pck-msg:<NavigateGoal> is deprecated: use my_robot_pck-msg:NavigateGoal instead.")))

(cl:ensure-generic-function 'target_pose-val :lambda-list '(m))
(cl:defmethod target_pose-val ((m <NavigateGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-msg:target_pose-val is deprecated.  Use my_robot_pck-msg:target_pose instead.")
  (target_pose m))

(cl:ensure-generic-function 'max_speed-val :lambda-list '(m))
(cl:defmethod max_speed-val ((m <NavigateGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-msg:max_speed-val is deprecated.  Use my_robot_pck-msg:max_speed instead.")
  (max_speed m))

(cl:ensure-generic-function 'avoid_obstacles-val :lambda-list '(m))
(cl:defmethod avoid_obstacles-val ((m <NavigateGoal>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-msg:avoid_obstacles-val is deprecated.  Use my_robot_pck-msg:avoid_obstacles instead.")
  (avoid_obstacles m))
