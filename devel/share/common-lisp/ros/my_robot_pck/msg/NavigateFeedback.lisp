...
(cl:defmethod cl:initialize-instance :after ((m <NavigateFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'NavigateFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_pck-msg:<NavigateFeedback> is deprecated: use my_robot_pck-msg:NavigateFeedback instead.")))

(cl:ensure-generic-function 'current_position-val :lambda-list '(m))
(cl:defmethod current_position-val ((m <NavigateFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-msg:current_position-val is deprecated.  Use my_robot_pck-msg:current_position instead.")
  (current_position m))

(cl:ensure-generic-function 'distance_to_goal-val :lambda-list '(m))
(cl:defmethod distance_to_goal-val ((m <NavigateFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-msg:distance_to_goal-val is deprecated.  Use my_robot_pck-msg:distance_to_goal instead.")
  (distance_to_goal m))

(cl:ensure-generic-function 'progress_percentage-val :lambda-list '(m))
(cl:defmethod progress_percentage-val ((m <NavigateFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-msg:progress_percentage-val is deprecated.  Use my_robot_pck-msg:progress_percentage instead.")
...
(cl:defmethod current_status-val ((m <NavigateFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-msg:current_status-val is deprecated.  Use my_robot_pck-msg:current_status instead.")
  (current_status m))
