...
(cl:in-package my_robot_pck-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <TemperatureConverter-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TemperatureConverter-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_pck-srv:<TemperatureConverter-request> is deprecated: use my_robot_pck-srv:TemperatureConverter-request instead.")))

(cl:ensure-generic-function 'celsius-val :lambda-list '(m))
(cl:defmethod celsius-val ((m <TemperatureConverter-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-srv:celsius-val is deprecated.  Use my_robot_pck-srv:celsius instead.")
  (celsius m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TemperatureConverter-request>)))
  ...
  "my_robot_pck/TemperatureConverterRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TemperatureConverter-request)))
  "Returns string type for a service object of type 'TemperatureConverter-request"
  "my_robot_pck/TemperatureConverterRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <TemperatureConverter-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TemperatureConverter-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name my_robot_pck-srv:<TemperatureConverter-response> is deprecated: use my_robot_pck-srv:TemperatureConverter-response instead.")))

(cl:ensure-generic-function 'fahrenheit-val :lambda-list '(m))
(cl:defmethod fahrenheit-val ((m <TemperatureConverter-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-srv:fahrenheit-val is deprecated.  Use my_robot_pck-srv:fahrenheit instead.")
  (fahrenheit m))

(cl:ensure-generic-function 'valid-val :lambda-list '(m))
(cl:defmethod valid-val ((m <TemperatureConverter-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader my_robot_pck-srv:valid-val is deprecated.  Use my_robot_pck-srv:valid instead.")
  (valid m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TemperatureConverter-response>)))
  ...
  "my_robot_pck/TemperatureConverterResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TemperatureConverter-response)))
  "Returns string type for a service object of type 'TemperatureConverter-response"
  "my_robot_pck/TemperatureConverterResponse")
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TemperatureConverter)))
  ...
  "my_robot_pck/TemperatureConverter")