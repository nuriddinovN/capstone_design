...
"""autogenerated by genpy from my_robot_pck/NavigateActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigateActionResult(genpy.Message):
  ...
  _type = "my_robot_pck/NavigateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot_pck/NavigateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_robot_pck.msg.NavigateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_robot_pck.msg.NavigateResult()
