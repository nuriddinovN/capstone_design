...
"""autogenerated by genpy from my_robot_pkg/NavigateActionResult.msg. Do not edit."""
import codecs
import sys
...
class NavigateActionResult(genpy.Message):
  _md5sum = "607d5d620e0ad1c16769ee02538f3bd6"
  _type = "my_robot_pkg/NavigateActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','my_robot_pkg/NavigateResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = my_robot_pkg.msg.NavigateResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = my_robot_pkg.msg.NavigateResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2f().pack(_x.result.total_distance, _x.result.time_elapsed))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.result.status_message = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.result.status_message = str[start:end]
      _x = self
      start = end
      end += 8
      (_x.result.total_distance, _x.result.time_elapsed,) = _get_struct_2f().unpack(str[start:end])
      return self
